...
public class GuiPatternFilter extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String title = "Blacklist / Whitelist";
    ...
    private void drawFilterScreen(int mouseX, int mouseY) {
        int mode = container.getFilterMode();
        String modeText = mode == ItemTest.FILTER_MODE_BLACKLIST ? "Blacklist" : "Whitelist";
        this.fontRenderer.drawString("Mode: " + modeText, 26, 20, 0x404040);
    ...
    private void drawFilterTooltip(int mouseX, int mouseY) {
        ...
        appendOreTooltip(lines, "Input", entry.inputOre);
        appendOreTooltip(lines, "Output", entry.outputOre);
        int guiLeft = (this.width - this.xSize) / 2;
        int guiTop = (this.height - this.ySize) / 2;
