...
public class ModConfig {
    ...
    public static String[] customOrePrefixes = new String[0];
    public static String[] customOreNames = new String[0];
    public static String[] customRecipePairs = new String[0];
