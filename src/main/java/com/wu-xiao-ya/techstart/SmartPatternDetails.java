...
public class SmartPatternDetails implements ICraftingPatternDetails {
    ...
    private int priority = 100; // EN: Original comment text was corrupted by encoding.
    // ZH: 原注释因编码问题已损坏。
    private final boolean isVirtual; // EN: Original comment text was corrupted by encoding.
    // ZH: 原注释因编码问题已损坏。
    private final int inputCount; // EN: Original comment text was corrupted by encoding.
    // ZH: 原注释因编码问题已损坏。
    private final int outputCount; // EN: Original comment text was corrupted by encoding.
    // ZH: 原注释因编码问题已损坏。
    ...
    private boolean isValidRecipe(String inputOre, String outputOre) {
        ...
        if (inputMaterial == null || outputMaterial == null) {
            return false; // EN: Original comment text was corrupted by encoding.
            // ZH: 原注释因编码问题已损坏。
        }
